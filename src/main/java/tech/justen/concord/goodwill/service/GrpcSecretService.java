...
public class GrpcSecretService extends SecretServiceGrpc.SecretServiceImplBase {
    ...
    @Override
    public void createKeyPair(CreateKeyPairRequest request, StreamObserver<CreateKeyPairResponse> responseObserver) {
        try {
            ...
            ApiResponse<PublicKeyResponse> resp = create(opts.getOrgName(), requestBody, PublicKeyResponse.class);
    ...
    @Override
    public void generateKeyPair(SecretParams request, StreamObserver<CreateKeyPairResponse> responseObserver) {
        try {
    ...
    @Override
    public void createUsernamePassword(CreateUsernamePasswordRequest request, StreamObserver<CreateSecretResponse> responseObserver) {
        try {
            SecretParams opts = request.getOptions();
            Map<String, Object> requestBody = createRequestBody(opts);
            ...
            ApiResponse<SecretOperationResponse> resp = create(opts.getOrgName(), requestBody, SecretOperationResponse.class);
    ...
    @Override
    public void createSecretValue(CreateSecretValueRequest request, StreamObserver<CreateSecretResponse> responseObserver) {
        try {
            SecretParams opts = request.getOptions();
            Map<String, Object> requestBody = createRequestBody(opts);
    ...
    @Override
    public void exportKeyPairAsFiles(GetSecretRequest request, StreamObserver<KeyPairFiles> responseObserver) {
        try {
            Map<String, String> result = secretService.exportKeyAsFile(getOrg(request.getOrg()), request.getName(), request.getStorePassword());
            String pk = result.get(SecretService.PRIVATE_KEY);
            String pub = result.get(SecretService.PUBLIC_KEY);
            responseObserver.onNext(KeyPairFiles.newBuilder().setPrivateKeyFile(pk).setPublicKeyFile(pub).build());
            responseObserver.onCompleted();
        } catch (Exception e) {
    ...
    @Override
    public void deleteSecret(DeleteSecretRequest request, StreamObserver<SecretResponse> responseObserver) {
        try {
            SecretsApi secretsApi = new SecretsApi(apiClient);
            GenericOperationResult result = secretsApi.delete(getOrg(request.getOrg()), request.getName());
    ...
    @Override
    public void updateAccessLevels(UpdateSecretAccessRequest request, StreamObserver<SecretResponse> responseObserver) {
        try {
            ...
            GenericOperationResult result = secretsApi.updateAccessLevel_0(getOrg(request.getOrgName()), request.getName(), levels);
            responseObserver.onNext(SecretResponse.newBuilder().build());
            responseObserver.onCompleted();
    ...
    @Override
    public void listAccessLevels(SecretRef request, StreamObserver<ListAccessEntryResponse> responseObserver) {
        try {
            SecretsApi secretsApi = new SecretsApi(apiClient);
            List<ResourceAccessEntry> levels = secretsApi.getAccessLevel(request.getOrgName(), request.getName());
    ...
    @Override
    public void getUsernamePassword(GetSecretRequest request, StreamObserver<UsernamePassword> responseObserver) {
        try {
            Map<String, String> result = secretService.exportCredentials(getOrg(request.getOrg()), request.getName(), request.getStorePassword());
            String user = result.get(SecretService.USERNAME);
            String pass = result.get(SecretService.PASSWORD);
            responseObserver.onNext(UsernamePassword.newBuilder().setUsername(user).setPassword(pass).build());
            responseObserver.onCompleted();
        } catch (Exception e) {
    ...
    public void exportAsFile(GetSecretRequest request, StreamObserver<SecretFile> responseObserver) {
        try {
            String filePath = secretService.exportAsFile(getOrg(request.getOrg()), request.getName(), request.getStorePassword());
    ...
    @Override
    public void exportAsString(GetSecretRequest request, StreamObserver<SecretString> responseObserver) {
        try {
            String secret = secretService.exportAsString(getOrg(request.getOrg()), request.getName(), request.getStorePassword());
    ...
    @Override
    public void encryptString(EncryptStringRequest request, StreamObserver<SecretString> responseObserver) {
        try {
            String encrypted = secretService.encryptString(getOrg(request.getOrg()), request.getProject(), request.getValue());
    ...
    private <T> ApiResponse<T> create(String org, Map<String, Object> requestBody, Class<T> responseType) throws ApiException {
        ...
        Call apiCall = apiClient.buildCall(url, "POST", null, null, null, headerParams, requestBody, authNames, null);
