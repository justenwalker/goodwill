...
class DockerImpl implements DockerService {
  ...
  private final com.walmartlabs.concord.runtime.v2.sdk.DockerService dockerService;

  public DockerImpl(com.walmartlabs.concord.runtime.v2.sdk.DockerService dockerService) {
    this.dockerService = dockerService;
  }

  @Override
  public int start(DockerContainer container, LogCallback outCallback, LogCallback errCallback)
      throws IOException, InterruptedException {
    return dockerService.start(
        ImmutableDockerContainerSpec.builder().from(new Spec(container)).build(),
        (String line) -> {
  ...
  private class Spec implements com.walmartlabs.concord.runtime.v2.sdk.DockerContainerSpec {
