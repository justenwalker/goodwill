...
public class SecretServiceImpl implements SecretService {
  ...
  public Map<String, String> exportKeyAsFile(String orgName, String name, String password)
      throws Exception {
    com.walmartlabs.concord.runtime.v2.sdk.SecretService.KeyPair kf =
        secretService.exportKeyAsFile(getOrgName(orgName), name, password);
  ...
  public Map<String, String> exportCredentials(String orgName, String name, String password)
      throws Exception {
    com.walmartlabs.concord.runtime.v2.sdk.SecretService.UsernamePassword up =
        secretService.exportCredentials(getOrgName(orgName), name, password);
    Map<String, String> m = new HashMap<>();
