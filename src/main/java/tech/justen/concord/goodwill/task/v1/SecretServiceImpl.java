...
public class SecretServiceImpl implements SecretService {
    ...
    public SecretServiceImpl(Context ctx, com.walmartlabs.concord.sdk.SecretService secretService, SecretsApi secretsApi) {
        this.ctx = ctx;
    ...
    public Map<String, String> exportKeyAsFile(String orgName, String name, String password) throws Exception {
        return secretService.exportKeyAsFile(ctx, getInstanceId(), getWorkDir(), getOrgName(orgName), name, password);
    }

    @Override
    public Map<String, String> exportCredentials(String orgName, String name, String password) throws Exception {
        return secretService.exportCredentials(ctx, getInstanceId(), getWorkDir(), getOrgName(orgName), name, password);
    }

    @Override
    public String exportAsFile(String orgName, String name, String password) throws Exception {
        return secretService.exportAsFile(ctx, getInstanceId(), getWorkDir(), getOrgName(orgName), name, password);
    }
    ...
    public String encryptString(String orgName, String projectName, String value) throws Exception {
        return secretService.encryptString(ctx, getInstanceId(), getOrgName(orgName), getProjectName(projectName), value);
    }
