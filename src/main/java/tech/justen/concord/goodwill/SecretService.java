...
public interface SecretService {
  ...
  Map<String, String> exportKeyAsFile(String orgName, String name, String password)
      throws Exception;

  Map<String, String> exportCredentials(String orgName, String name, String password)
      throws Exception;

  String exportAsFile(String orgName, String name, String password) throws Exception;
