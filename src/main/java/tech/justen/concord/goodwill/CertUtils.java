...
public class CertUtils {
    public static class CA {
        ...
        public void generatePKI(File caCert, File certFile, File keyFile) throws Exception {
            ...
            X509v3CertificateBuilder issuedCertBuilder = new X509v3CertificateBuilder(cert.getSubject(), serial, startDate, endDate, csr.getSubject(), csr.getSubjectPublicKeyInfo());
            ...
            issuedCertBuilder.addExtension(Extension.authorityKeyIdentifier, false, issuedCertExtUtils.createAuthorityKeyIdentifier(cert));
            ...
            X509Certificate cert = new JcaX509CertificateConverter().setProvider(BC_PROVIDER).getCertificate(issuedCertHolder);
    ...
    public static CA generateCA() throws Exception {
        ...
        rootCertBuilder.addExtension(Extension.subjectAlternativeName, false, new DERSequence(new ASN1Encodable[]{
