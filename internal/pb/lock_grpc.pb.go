...
const (
	LockService_ProjectLock_FullMethodName   = "/lock.LockService/ProjectLock"
	LockService_ProjectUnlock_FullMethodName = "/lock.LockService/ProjectUnlock"
)
...
func (c *lockServiceClient) ProjectLock(ctx context.Context, in *Lock, opts ...grpc.CallOption) (*LockResult, error) {
	out := new(LockResult)
	err := c.cc.Invoke(ctx, LockService_ProjectLock_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *lockServiceClient) ProjectUnlock(ctx context.Context, in *Lock, opts ...grpc.CallOption) (*LockResult, error) {
	out := new(LockResult)
	err := c.cc.Invoke(ctx, LockService_ProjectUnlock_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _LockService_ProjectLock_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: LockService_ProjectLock_FullMethodName,
	}
...
func _LockService_ProjectUnlock_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: LockService_ProjectUnlock_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
